        ...
        <div class="row">
            <div class="large-8 column">
                ...
                <form action="<c:url value="/product/save"/>" method="post">
                    <p>Product Code:<input type="text" name="txtCode"/></p>
                    <p>Product Name<input type="text" name="txtName"/></p>
                    <p>
                        Product Category:
                    ...
                    <p>Product Price:<input type="text" name="txtPrice"/></p>
                    <p>Product Description<input type="text" name="txtDesc"/></p>
